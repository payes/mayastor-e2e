...
func IsPodRunning(clientset kubernetes.Clientset, podName string, nameSpace string) bool {
...
func GetPodStatus(clientset kubernetes.Clientset, podName string, nameSpace string) (v1.PodPhase, error) {
	pod, err := clientset.CoreV1().Pods(nameSpace).Get(context.TODO(), podName, metaV1.GetOptions{})
	if err != nil {
...
func CreatePod(clientset kubernetes.Clientset, podDef *coreV1.Pod, nameSpace string) (*coreV1.Pod, error) {
