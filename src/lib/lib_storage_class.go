...
func NewScBuilder() *ScBuilder {
	...
	scObject := obj.WithProvisioner(CSIProvisioner)

	// set default replicas value i.e 1
	scObject = scObject.WithReplicas( /*DefaultReplicaCount*/ 2)
	return scObject
}
...
func (b *ScBuilder) WithReplicas(value int) *ScBuilder {
	...
	b.sc.object.Parameters[string(ScReplicas)] = strconv.Itoa(value)
	return b
}

// WithFileType sets the fsType parameter of storageclass with provided argument.
func (b *ScBuilder) WithFileSystemType(value FileSystemType) *ScBuilder {
	if value != NoneFsType {
		if b.sc.object.Parameters == nil {
			b.sc.object.Parameters = map[string]string{}
		}
		b.sc.object.Parameters[string(ScFsType)] = string(value)
	}
	return b
}

// WithProtocol sets the protocol parameter of storageclass with provided argument.
func (b *ScBuilder) WithProtocol(value ShareProto) *ScBuilder {
	if b.sc.object.Parameters == nil {
		b.sc.object.Parameters = map[string]string{}
	}
	b.sc.object.Parameters[string(ScProtocol)] = string(value)
	return b
}
...
func (b *ScBuilder) WithLocal(value bool) *ScBuilder {
	...
	b.sc.object.Parameters[string(ScLocal)] = strconv.FormatBool(value)
	return b
}
...
func (b *ScBuilder) WithIOTimeout(value int) *ScBuilder {
	...
	b.sc.object.Parameters[string(IOTimeout)] = strconv.Itoa(value)
	return b
}
...
func (b *ScBuilder) Build() (*storagev1.StorageClass, error) {
	...
	if b.sc.object.Parameters[ScProtocol] == string(ShareProtoNvmf) && b.sc.object.Parameters[IOTimeout] == "" {
		b.sc.object.Parameters[IOTimeout] = "30"
		logf.Log.Info("NewScBuilder: \"defaulting\" ioTimeout", "value", b.sc.object.Parameters[IOTimeout])
	}
...
func (b *ScBuilder) BuildAndCreate(clientset kubernetes.Clientset) error {
	scObj, err := b.Build()
	if err == nil {
		err = CreateSc(clientset, scObj)
	}
	return err
}

// CreateSc creates storageclass with provided storageclass object
func CreateSc(clientset kubernetes.Clientset, obj *storagev1.StorageClass) error {
