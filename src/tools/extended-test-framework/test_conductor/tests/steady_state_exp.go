...
func SteadyStateExpTest(testConductor *tc.TestConductor) error {
	...
	if err = k8sclient.DeployFio(
		...
		pvc_name,
		vol_type,
		testConductor.Config.SteadyStateExp.VolumeSizeMb,
		1000000,
		testConductor.Config.SteadyStateExp.ThinkTime,
		testConductor.Config.SteadyStateExp.ThinkTimeBlocks,
	); err != nil {
