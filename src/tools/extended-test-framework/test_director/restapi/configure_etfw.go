...
//go:generate swagger generate server --target ../../test_director --name Etfw --spec ../swagger_test_director_oas2.yaml --principal interface{}

var TestPlanMap = map[string]*models.TestPlan{}
...
func configureAPI(api *operations.EtfwAPI) http.Handler {
	...
	api.TestDirectorPutTestPlanByIDHandler = test_director.PutTestPlanByIDHandlerFunc(func(params test_director.PutTestPlanByIDParams) middleware.Responder {
		...
		TestPlanMap[params.Body.Name] = &tp
