...
NIGHTLY_FULL_TESTS="install basic_volume_io csi resource_check pvc_stress_fio replica rebuild io_soak multiple_vols_pod_io mayastorpool_schema ms_pod_restart nexus_location pool_modify pvc_readwriteonce volume_filesystem ms_pod_disruption uninstall"
