...
EXTENDED_TESTS="install basic_volume_io csi resource_check rebuild io_soak multiple_vols_pod_io pool_modify volume_filesystem mayastorpool_schema ms_pod_disruption pvc_readwriteonce uninstall" # replica removed
